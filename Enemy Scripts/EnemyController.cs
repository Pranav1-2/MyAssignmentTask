...
public class EnemyController : MonoBehaviour {
	...
	// Update is called once per frame and checks what the enemy is doing and executes a function accordingly
	void Update () 
    {
    ...
    void Patrol() 
    {
        ...
        //moves around aimlessly to random locations
    ...
    //finds new random location and moves the enemy towards it
    ...
    //activates the Attack Point
    void Turn_On_AttackPoint() 
    {
        attack_Point.SetActive(true);
    }

    //Deactivates the attack point
